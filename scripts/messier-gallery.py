...
for pic in new_gallery:
    ...
    if not found:
        ...
        try:
          sort_id = int(object_name.replace("M",""))
        except ValueError:
          sort_id = 9999
        old_gallery.append({"filename": pic, "sizes": new_gallery[pic], "thumbnail": thumbs[pic], "original": originals[pic], "title": object_name, "sort_id": sort_id})
